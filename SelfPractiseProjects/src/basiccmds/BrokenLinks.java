...
// TODO Auto-generated method stub
	 ...
	 * for (WebElement link : links)
	 * 
	 * { System.out.println(link); String url = link.getAttribute("href");
	 * System.out.println("#########################################");
	 ...
	 * int respCode = conn.getResponseCode();
	 * 
	 * System.out.println(respCode); if (respCode < 400) {
	 * System.out.println("The link with Text  " + link.getText() +
	 * " is broken with code" + respCode); }
	 * 
	 * // a.assertTrue(respCode < 400, "The link with Text" + link.getText() + " is
	 * // broken with code" + respCode);
	 * 
	 * }
	 */
